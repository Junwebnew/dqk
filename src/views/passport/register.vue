    ...
    <div class="reg">
        ...
        <div class="content">
            ...
            <div class="step stepOne" v-if='navStep == 0'>
                ...
                <div class="stepItem text-left">
                    <input type="text" maxlength="8" v-model="msgCode" class="msgCode" placeholder="短信验证码" ref='msgCode' @keyup.enter="netxStep(1)">
            ...
            <div class="step stepOne"  v-if='navStep == 1'>
                ...
                <div class="stepItem">
                    <input :type=" passSee ? 'text' : 'password' " maxlength="18" v-model="pass" placeholder="请输入由6-18位数字或字母组成的密码" ref='pass'>
                    <span :class="{'eyes':true,open:passSee}" @click=" passSee = !passSee"></span>
                </div>
                <div class="stepItem">
                    <input :type=" reSee ? 'text' : 'password' "  maxlength="18" v-model="rePass" placeholder="请重复由6-18位数字或字母组成的密码" ref='rePass'  @keyup.enter="netxStep(2)">
    ...
    methods:{
        async netxStep(step){
            if(step == 1){
                ...
                let vailImgCode = await  this.$Api("imgCode/check",{'code': this.imgCode},'get',false,false,this.apiSwitchImg)
            
                if(vailImgCode.code != 0) return;

                //验证短信验证码
                let msgCode = await  this.$Api("smsCode/check",{'code': this.msgCode,'phone':this.userPhone},'get',false,false,this.apiSwitchImg)
