            ...
            <div class="yke_main">
                ...
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="demo-ruleForm">
                    ...
                    <el-form-item prop="phone" class="jun">
                        <el-input type="text" v-model="ruleForm.phone" placeholder="请输入您的手机号码" prefix-icon="el-icon-mobile-phone"
                            maxlength="11" clearable></el-input>
                    </el-form-item>
                    <el-form-item prop="pass">
                        <el-input type="password" v-model="ruleForm.pass" placeholder="请输入您的密码" @keyup.enter.native="submitForm('ruleForm')"
                            prefix-icon="el-icon-edit" clearable></el-input>
                    </el-form-item>
                    <el-form-item class="item2 text-left">
                        <el-checkbox v-model="checkedNext">下次自动登录</el-checkbox>
                        <!-- <a href="javascript:void(0)" @click='forgetPass' class="forgetPass col">忘记密码?</a> -->
                        <router-link to="/passport/register" class="forgetPass col fr">注册新账号</router-link>
                    </el-form-item>
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    ...
                    this.$Api('sysUser/login', {
                            ...
                            "time": this.checkedNext ? 7 : 0
                        }, 'post', true, false, this.requireFunc)
                        .then(res => {
                            let json = res.data
